...
- [前言](#前言)
- [关于[Language Server Protocol](https://microsoft.github.io/language-server-protocol/)和async](#---language-server-protocol--https---microsoftgithubio-language-server-protocol---async)
- [安装](#install)
...
## 关于[Language Server Protocol](https://microsoft.github.io/language-server-protocol/)和async 
### lsp是什么
